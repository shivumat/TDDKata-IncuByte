    ...
    public int Add(String numbersAsString){
        ...
        if(numbersAsString.startsWith("//")){
            ...
            while (bracketOpenIndex > ZERO) {
                String newDelimiter = numbersAsString.substring(bracketOpenIndex, bracketOpenIndex + ONE);
                setDelimiter(newDelimiter);
                bracketOpenIndex = numbersAsString.indexOf(BRACKET_OPEN, bracketOpenIndex+ONE)+ONE;
